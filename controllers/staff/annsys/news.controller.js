...
// % ROUTE: mypupqc/v1/annsys/pup_staff/get_news_from_user
...
// % ROUTE: mypupqc/v1/annsys/pup_staff/get_all_news
...
// % Get Specific News
// % ROUTE: mypupqc/v1/annsys/pup_staff/get_news/:announcement_id
...
// % Add News
// % ROUTE: mypupqc/v1/annsys/pup_staff/add_news
...
// % Edit News
// % ROUTE: mypupqc/v1/annsys/pup_staff/edit_news/:announcement_id
exports.editNews = (req, res) => {
   ...
   if (!req.files) {
       db.Announcement.update(req.body, {where:{announcement_id: announcement_id}})
           .then(data => {
               dataResponse(res, data, 'News successfully updated.', 'News not updated.')
           })
           .catch(err => {
               errResponse(res, err)
           })
...
// % ROUTE: mypupqc/v1/annsys/pup_staff/change_news_status/:announcement_id
...
// % Delete News
// % ROUTE: mypupqc/v1/annsys/pup_staff/delete_news/:announcement_id
